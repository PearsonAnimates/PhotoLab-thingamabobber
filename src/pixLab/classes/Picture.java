...
public class Picture extends SimplePicture 
{
  ...
  public void trollfaceLolFilter(int startRow, int startCol)
  {
	  Pixel fromPixel = null;
	  Pixel toPixel = null;
	  Picture trollfaceLol = new Picture("trollfaceLol.png");
	  Pixel [][] toPixels = this.getPixels2D(); //The base layer of the picture.
	  Pixel [][] fromPixels = trollfaceLol.getPixels2D(); //The layer we are adding to the picture.
	  int fromRow = 0;
